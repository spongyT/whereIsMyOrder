...
<application> element:
    ...
    */
    ...
    public static final String AUTHORITY = "com.spongyt.wimo.repository.provider";
    ...
    private static final String TABLENAME = OrderDao.TABLENAME;
    private static final String PK = OrderDao.Properties.Id
    .columnName;
    ...
    sURIMatcher.addURI(AUTHORITY, BASE_PATH, ORDER_DIR);
